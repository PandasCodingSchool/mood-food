...
const GAMES: Game[] = [
  ...
  },
  {
    id: "this_or_that",
    title: "This or That",
    description: "Quick-fire duels that teach us what you really trade off for",
    icon: Swords,
  ...
  },
  {
    id: "craving_radar",
    title: "Craving Radar",
    description: "Tap the sensations pulling you — crunchy, melty, spicy, fresh",
    icon: Radar,
  ...
  },
  {
    ...
    description: "Tournament-style — pick a winner each round, limited time",
    icon: Trophy,
  ...
  },
  {
    ...
    description: "Tell us what you have — cook it or order instead",
    icon: Refrigerator,
  ...
  },
  {
    id: "group",
    title: "Group Decide",
    description: "Everyone swipes, we find what nobody's miserable about",
    icon: Users,
