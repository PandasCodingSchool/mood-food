  ...
  return (
    <View style={{ flex: 1, backgroundColor: theme.bg }}>
      ...
      <ScrollView contentContainerStyle={{ padding: 24, paddingBottom: 140, gap: 16 }} showsVerticalScrollIndicator={false}>
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 10 }}>
          ...
          <View style={{ flex: 1 }}>
            ...
            {app.isLive && app.restaurantName && (
              <Text style={[fw(600), { fontSize: 12, color: theme.subtext, marginTop: 1 }]} numberOfLines={1}>{app.restaurantName}</Text>
            )}
          </View>
        </View>

        <View style={{ borderRadius: 20, overflow: 'hidden', backgroundColor: theme.card }}>
          {imageUrl ? (
            <Image
              source={{ uri: imageUrl }}
        ...
        <View style={{ padding: 16, borderRadius: 16, backgroundColor: theme.surface, gap: 14 }}>
        ...
        <View style={{ flexDirection: 'row', gap: 12 }}>
          <View style={{ flex: 1, padding: 16, borderRadius: 16, backgroundColor: colors.green + '0F', alignItems: 'center' }}>
            <Clock size={24} color={colors.green} />
          ...
          <View style={{ flex: 1, padding: 16, borderRadius: 16, backgroundColor: colors.orange + '0F', alignItems: 'center' }}>
            <Car size={24} color={colors.orange} />
        ...
        <View style={{ padding: 16, borderRadius: 16, backgroundColor: theme.surface, gap: 10 }}>
